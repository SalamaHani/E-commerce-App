            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <span className="absolute z-30 text-gray-500 -translate-y-1/2 cursor-pointer right-4 top-[24px] dark:text-gray-400">
                    <svg
              ...
              <div className="flex items-center justify-between">
                <Link
                  to="/Forgotpassword"
                  className="text-sm dark:text-gray-400 text-brand-500 hover:text-brand-600 dark:text-brand-400"
                >
                  Forgot password?
                </Link>
              </div>
