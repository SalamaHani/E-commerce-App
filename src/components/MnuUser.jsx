...
import { logoutuser, togetllMnuuser } from "../features/User/userSlice";
...
function MnuUser() {
  ...
  return (
    <>
      <div
        x-show="dropdownOpen"
        className="absolute  dark:bg-gray-900  right-[0px] top-[82px] mt-[0] flex w-[260px] flex-col rounded-2xl border border-gray-200 bg-white p-3 shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark"
      >
        <div className="py-3">
